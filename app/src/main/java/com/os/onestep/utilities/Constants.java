...
public class Constants {
    ...
    public static final String MAIN_URL = "http://divsinfotech.com/OneStep/api/";
    public static final String LOGIN_URL = MAIN_URL + "loginobjvalidate2?";
    public static final String SIGNUP_URL = MAIN_URL + "signupact?";
    ...
    public static final String MESSSAGE_KEY = "message";
